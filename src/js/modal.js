...
const closeElement = document.querySelector('.modal__btn');
...
function renderModal(ev) {
  ...
  modal.querySelectorAll('.modal__button').forEach(btn => {
  ...
  if (moreBtn) {
    moreBtn.onclick = function () {
      window.open(
        'https://www.google.com/search?q=' + encodeURIComponent(artist),
        '_blank'
      );
    };
  }
