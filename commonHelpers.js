(function(){const n=document.createElement("link").relList;if(n&&n.supports&&n.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))o(s);new MutationObserver(s=>{for(const l of s)if(l.type==="childList")for(const d of l.addedNodes)d.tagName==="LINK"&&d.rel==="modulepreload"&&o(d)}).observe(document,{childList:!0,subtree:!0});function i(s){const l={};return s.integrity&&(l.integrity=s.integrity),s.referrerPolicy&&(l.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?l.credentials="include":s.crossOrigin==="anonymous"?l.credentials="omit":l.credentials="same-origin",l}function o(s){if(s.ep)return;s.ep=!0;const l=i(s);fetch(s.href,l)}})();function B(e=""){return fetch(`https://app.ticketmaster.com/discovery/v2/events.json?apikey=rvylvsHWc98giycRfhDFKtIp8G9FNDPl${e}`).then(n=>n.json())}const z=document.querySelector(".hero__list"),C=document.querySelector(".header__inp"),q=document.querySelector(".header__btn"),S=document.querySelector(".header__input");let v=[];function F(e,n=60){return e.length<=n?e:e.slice(0,n).trim()+"..."}function Z(e,n=50){return e.length<=n?e:e.slice(0,n).trim()+"..."}function O(e){var d,M,y,u;let n="./img/modal-decstop.jpg";if(e.images&&e.images.length>0){for(let m=0;m<e.images.length;m++)if(e.images[m].width>=640){n=e.images[m].url;break}n==="./img/modal-decstop.jpg"&&(n=e.images[0].url)}const i=Z(e.name,30),o=((M=(d=e.dates)==null?void 0:d.start)==null?void 0:M.localDate)||"Unknown date",s="data:image/svg+xml;base64,";let l="Unknown place";return((u=(y=e._embedded)==null?void 0:y.venues)==null?void 0:u.length)>0&&(l=e._embedded.venues[0].name||l),l=F(l,15),`
  ...
  `}function x(e){z.innerHTML=e.map(O).join(""),window.lastEvents=e}function G(){const e=C.value.trim(),n=S.value;let i="&size=30";return e.length>0&&(i+="&keyword="+encodeURIComponent(e)),n.length>0&&(i+="&countryCode="+n),i}function b(){B(G()).then(e=>{var n,i;((i=(n=e._embedded)==null?void 0:n.events)==null?void 0:i.length)>0?(v=e._embedded.events,x(v)):z.innerHTML="<li>Nothing found</li>"}).catch(e=>{console.error(e),z.innerHTML="<li>Nothing found</li>"})}q.addEventListener("click",e=>{e.preventDefault(),b()});C.addEventListener("input",b);S.addEventListener("change",b);async function Q(){return(await(await fetch("https://restcountries.com/v3.1/all?fields=name,cca2")).json()).filter(i=>{var o;return i.cca2&&((o=i.name)==null?void 0:o.common)}).map(i=>({code:i.cca2,name:i.name.common})).sort((i,o)=>i.name.localeCompare(o.name,"uk"))}async function Y(e){const n=await Q(),i='<option value="">Choose country</option>',o=n.map(s=>`<option value="${s.code}">${s.name} (${s.code})</option>`).join("");e.innerHTML=i+o,e.value=""}document.addEventListener("DOMContentLoaded",async()=>{await Y(S),b(),S.addEventListener("change",b)});const U=document.querySelector(".backdrop");document.querySelector(".modal__btn");const W=document.querySelector(".hero");W.addEventListener("click",e=>{if(e.target.closest(".hero__item"))U.style.opacity="1",U.style.pointerEvents="all";else return});const L=document.querySelector(".pagination"),w=document.querySelector(".hero__list"),N=document.querySelector(".header__inp"),$=document.querySelector(".header__btn"),D=document.querySelector(".header__input");if(!(!L||!w)){let l=function(t,a){const c=Math.floor(999/a)+1;return Math.min(t,c)},d=function(t,a=60){return t?t.length<=a?t:t.slice(0,a).trim()+"...":""},M=function(t,a=50){return t?t.length<=a?t:t.slice(0,a).trim()+"...":""},y=function(t){var E,g,A,k;let a="./img/modal-decstop.jpg";if(t.images&&t.images.length>0){for(let T=0;T<t.images.length;T++)if(t.images[T].width>=640){a=t.images[T].url;break}a==="./img/modal-decstop.jpg"&&(a=t.images[0].url)}const c=M(t.name,30),r=((g=(E=t.dates)==null?void 0:E.start)==null?void 0:g.localDate)||"Unknown date",f="data:image/svg+xml;base64,";let h="Unknown place";return((k=(A=t._embedded)==null?void 0:A.venues)==null?void 0:k.length)>0&&(h=t._embedded.venues[0].name||h),h=d(h,15),`
      <li class="hero__item">
        <div class="hero__card">
